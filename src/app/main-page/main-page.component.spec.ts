...
describe('MainPageComponent', () => {
  ...
  beforeEach(async(() => {
    ...
    messagesServiceStub.getAll.and.returnValue(({author: 'admin', title: 'First message', body: 'First message body'}));
  ...
  it('should get messages from server', fakeAsync(() => {
    const messageService = fixture.debugElement.injector.get(MessagesService) as any;

    component.ngOnInit();

    fixture.detectChanges(); // onInit()

    expect(messageService.getAll.calls.any()).toBe(true);
  }));
});
